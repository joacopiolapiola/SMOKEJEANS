...
<head>
    <?php 
        // Rescatamos todas las categorías existentes
    ...
    <form action="" method="get">
        <select name="cat" id="">
            ...
            foreach($categorias as $c){
                echo "<option value=\"" . htmlspecialchars($c['id'], ENT_QUOTES, 'UTF-8') . "\">" 
...
// Buscamos todos los productos de la categoría elegida.
        ...
        <?php else: ?>
            ...
            <?php foreach ($productos as $producto): ?>
                ...
                <article class="producto">
                    ...
                    <a href="https://wa.me/<?= htmlspecialchars($numerowhatsapp ?? '', ENT_QUOTES, 'UTF-8') ?>?text=ID: <?= htmlspecialchars($producto['id'], ENT_QUOTES, 'UTF-8') ?>"
                       target="_blank"
